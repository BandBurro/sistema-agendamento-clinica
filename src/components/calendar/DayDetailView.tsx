...
interface Props {
  day: Date;
  appointments: AppointmentWithRelations[]; // Full week — filtered internally to this day
  loading: boolean;
  onBack: () => void;
      ...
      <div className="flex-1 overflow-y-auto">
        {!loading && dayAppts.length === 0 ? (
          ...
          <div className="flex" style={{ height: TOTAL_HEIGHT }}>
            ...
            {/* Day column */}
            <div
              className={`flex-1 relative ${today ? "bg-indigo-50/20" : ""}`}
              ...
              {dayAppts.map((appt) => {
                ...
                return (
                  <button
                    ...
                    className={`rounded border-l-[3px] px-2.5 py-1 text-left overflow-hidden cursor-pointer transition-all z-10 ${BLOCK_STYLES[appt.status]} ${
